...
- **Security and backup boundary (round 200).** Imported/downloaded models live
  ...
  pass. The recording service is non-sticky and renews a 30-minute wake-lock
...
- **Build/release config (r158, r194, r199, r200):** SDK levels are PINNED in
  ...
  AAB build. CI repeats the unsigned checks; Dependabot watches Pub and Gradle.
