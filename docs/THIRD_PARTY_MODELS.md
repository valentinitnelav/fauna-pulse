...
## BioCLIP 2 (identification, round 208)
...
- Also cite the original BioCLIP (Stevens et al., CVPR 2024) and OpenCLIP, as the model card requests.

The converted files are unofficial conversions made by FaunaPulse users on their own PCs;
