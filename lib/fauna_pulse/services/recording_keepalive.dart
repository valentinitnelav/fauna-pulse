...
//  2. **Battery settings** — checking, and (once) offering Android's normal
//     settings page where the user can choose unrestricted operation for
//     aggressive OEM "battery managers" (notably MIUI / Xiaomi).
//
...
class RecordingKeepAlive {
  ...
  /// Opens Android's battery-optimization settings, where the user can choose
  /// whether FaunaPulse may run without restrictions. Returns whether the
